...
type IconProps = {
  size: SvgProps["width"]
  color: SvgProps["fill"]
} & Omit<SvgProps, "width" | "height" | "fill" | "viewBox">

function Moon(props: IconProps) {
  const { size, color, ...restProps } = props

  return (
    <svg viewBox="0 -1 32 32" width={size} height={size} {...restProps}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
function Sun(props: IconProps) {
  ...
  return (
    <svg viewBox="0 -2 32 32" width={size} height={size} {...restProps}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
type ColorSchemeWidgetIconProps = {
  as: "sun" | "moon"
  color?: IconProps["color"]
} & Omit<IconProps, "as" | "color">

const ColorSchemeWidgetIcon = memo((props: ColorSchemeWidgetIconProps) => {
...
export default ColorSchemeWidgetIcon
